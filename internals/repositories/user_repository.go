...
type UserRepository interface {
	Add(ctx *gin.Context, username, password, email string)
...
func (r *repository) Add(ctx *gin.Context, username string, password string, email string) {
	r.Queries.CreateUser(ctx, database.CreateUserParams{Username: username, Password: password, Email: email})
}
